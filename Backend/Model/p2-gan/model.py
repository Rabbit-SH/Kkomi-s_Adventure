...
# 텐서 관련 유틸리티 함수 라이브러리 (tensor 1.x version)
...
discriminator_cfg_p32 = {
	'l_num': 3,	#레어이 3개로 증가
	'l0_c': 3,                           # 1024
	'l1_c': DL1C,   'l1_k': 4, 'l1_s': 4, # 256
	'l2_c': DL2C,   'l2_k': 4, 'l2_s': 4, # 64
	'l3_c': DL3C,   'l3_k': 4, 'l3_s': 4, # 16
}
...
supported_patch_size = {
	...
	32: discriminator_cfg_p32
}

# 이동평균 업데이트 속도 (조정하면 결과차이가 나긴하나?)
batch_norm_decay=0.95
# 배치 정규화 단계에서 분모 0 방지 (큰 의미없을듯)
